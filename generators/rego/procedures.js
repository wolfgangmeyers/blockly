...
Blockly.Rego['procedures_defreturn'] = function (block) {
  ...
  var funcName = Blockly.Rego.variableDB_.getName(block.getFieldValue('NAME'), Blockly.PROCEDURE_CATEGORY_NAME);
  var xfix1 = '';
  ...
  var returnValue = Blockly.Rego.valueToCode(block, 'RETURN', Blockly.Rego.ORDER_NONE) || '';
  var xfix2 = '';
